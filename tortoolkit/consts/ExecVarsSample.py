try:
    ...
    class ExecVars:
        ...
        API_HASH = "12e337600a278b091b148bf2c8c4664d"
        API_ID = 15418326
        BOT_TOKEN = "5825221434:AAGxGv6HqVnM9vNbQzeYmZFw7VKHq04A3T4"
        BASE_URL_OF_BOT = "http://170.187.251.233"

        # Edit the server port if you want to keep it default though.
        SERVPORT = 80

        # ALLOWED USERS [ids of user or supergroup] seperate by commas
        ALD_USR = [-1001566316006]
        OWNER_ID = 5074351834
